...
# La variable app contendrÃ¡ toda la lÃ³gica, configuraciones y control.
app = Flask(__name__)
CORS(app)
# Carga masiva desde la clase Config
app.config.from_object(Config)
# Conectamos el swagger con la explicaciÃ³n + ejemplos de todos los endpoints.
app.config['SWAGGER'] = {
    'openapi': '3.0.0',
    'uiversion': 3
}
...
with app.app_context():
    db.create_all()
# --- RUTAS PARA VER EL FRONTEND DESDE NG ROK ---
@app.route('/')
def servir_index():
